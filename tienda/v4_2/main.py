...
Qué problemas tiene esta versión (v4_1): BUGS
    12. El cliente no sabe cuantos productos va a llevar
'''
...
i = 0
#El ciclo while se utiliza cuando NO se sabe cuantas veces se va a repetir
        ...
        if precio_del_producto < 0: #Solución al BUG número 5
            ...
            if descuento < 0: #Solucíon al BUG número 7
                ...
                if precio_del_producto < descuento: #Solución al BUG número 8
                    ...
                    i = i + 1
                    print ("Desea_llevar_otro_producto? s/n: ")
